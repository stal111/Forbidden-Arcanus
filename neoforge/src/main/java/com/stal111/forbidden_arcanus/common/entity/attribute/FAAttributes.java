...
public class FAAttributes {
    ...
    public static final Holder<Attribute> MAGIC_PROTECTION = HELPER.register("generic.magic_protection", () -> new PercentageAttribute("attribute.name.generic.magic_protection", 0.0D, 0.0D, 1.0).setSyncable(true));
