...
public final class EssenceStorages {
    ...
    public static final EssenceStorage ECTO_BLASTER_EMPTY = createEmpty(EssenceType.ECTOPLASM, 1500);
    public static final EssenceStorage CLIBANO_ECTOPLASM_EMPTY = createEmpty(EssenceType.ECTOPLASM, 250);
}
