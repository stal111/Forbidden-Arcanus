...
public class EssenceSourceTypes {
    ...
    public static final Supplier<EssenceSourceType<?>> FROM_COMPONENT = HELPER.register("from_component", () -> new EssenceSourceType<>(DataComponentEssenceSource.CODEC.fieldOf("component"), DataComponentEssenceSource.STREAM_CODEC));
