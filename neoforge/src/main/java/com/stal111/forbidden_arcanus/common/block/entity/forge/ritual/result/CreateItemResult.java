 ...
 * @since 2023-02-05
 */
public record CreateItemResult(ItemStackTemplate result) implements RitualResult {

    public static final MapCodec<CreateItemResult> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ItemStackTemplate.CODEC.fieldOf("result_item").forGetter(CreateItemResult::result)
