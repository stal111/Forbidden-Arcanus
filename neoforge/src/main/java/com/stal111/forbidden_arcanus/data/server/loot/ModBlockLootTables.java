...
public class ModBlockLootTables extends ValhelsiaBlockLootTables {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.DEORUM_DOOR.get(), block -> this.createSinglePropConditionTable(block, BlockStateProperties.DOUBLE_BLOCK_HALF, DoubleBlockHalf.LOWER));
        this.add(ModBlocks.FUNGYSS_DOOR.get(), block -> this.createSinglePropConditionTable(block, BlockStateProperties.DOUBLE_BLOCK_HALF, DoubleBlockHalf.LOWER));
        this.add(ModBlocks.AURUM_DOOR.get(), block -> this.createSinglePropConditionTable(block, BlockStateProperties.DOUBLE_BLOCK_HALF, DoubleBlockHalf.LOWER));
        this.add(ModBlocks.EDELWOOD_DOOR.get(), block -> this.createSinglePropConditionTable(block, BlockStateProperties.DOUBLE_BLOCK_HALF, DoubleBlockHalf.LOWER));
        this.add(ModBlocks.ARCANE_EDELWOOD_DOOR.get(), block -> this.createSinglePropConditionTable(block, BlockStateProperties.DOUBLE_BLOCK_HALF, DoubleBlockHalf.LOWER));
