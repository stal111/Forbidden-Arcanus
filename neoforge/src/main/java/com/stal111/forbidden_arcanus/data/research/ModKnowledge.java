...
public class ModKnowledge extends DatapackRegistryClass<Knowledge> {
    ...
    public void bootstrap(BootstrapContext<Knowledge> context) {
        var welcome = context.register(WELCOME, new Knowledge(new DisplayInfo(Component.literal("Welcome!"), Component.literal("The start of an adventure."), FrameType.DEFAULT, new TextureIcon(ForbiddenArcanus.identifier("textures/gui/research/icon/feather.png")), 0, 0), List.of()));
