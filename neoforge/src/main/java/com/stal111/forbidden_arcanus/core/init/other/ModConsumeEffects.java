...
public class ModConsumeEffects {
    ...
    public static final RegistryEntry<ConsumeEffect.Type<?>, ConsumeEffect.Type<AddEssenceConsumeEffect>> ADD_ESSENCE = HELPER.register("add_essence", () -> new ConsumeEffect.Type<AddEssenceConsumeEffect>(AddEssenceConsumeEffect.CODEC, AddEssenceConsumeEffect.STREAM_CODEC));
}
