...
import com.stal111.forbidden_arcanus.common.block.entity.forge.ritual.result.*;
...
public class ModRitualResultTypes implements RegistryClass {
    ...
    public static final RegistryEntry<RitualResultType<?>, RitualResultType<TransmuteInputResult>> TRANSMUTE_INPUT = register("transmute_input", TransmuteInputResult.CODEC);
