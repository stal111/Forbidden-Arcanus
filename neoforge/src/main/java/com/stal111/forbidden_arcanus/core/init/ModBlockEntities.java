...
public class ModBlockEntities implements RegistryClass {
    ...
    public static final RegistryEntry<BlockEntityType<?>, BlockEntityType<EssenceCauldronBlockEntity>> ESSENCE_CAULDRON = HELPER.register("essence_cauldron", () -> new BlockEntityType<>(EssenceCauldronBlockEntity::new, ModBlocks.ESSENCE_CAULDRON.get()));
    public static final RegistryEntry<BlockEntityType<?>, BlockEntityType<HephaestusForgeBlockEntity>> HEPHAESTUS_FORGE = HELPER.register("hephaestus_forge", () -> new BlockEntityType<>(HephaestusForgeBlockEntity::new, ModBlocks.HEPHAESTUS_FORGE.get()));
