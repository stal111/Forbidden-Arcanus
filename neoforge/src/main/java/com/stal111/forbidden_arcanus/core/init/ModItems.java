...
public class ModItems implements RegistryClass {
    ...
    public static final ItemRegistryEntry<MagicWandItem> MAGIC_WAND = HELPER.register("magic_wand", () -> new MagicWandItem(new Item.Properties().stacksTo(1).requiredFeatures(ForbiddenArcanus.UPDATE_2_6).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.WAND_PARTS, new WandParts(new WandPart(Component.literal("Aurum Wood"), new WandStats(20, 0, 0)), new WandPart(Component.literal("Deorum"), new WandStats(0, 10, 0)), new WandPart(Component.literal("Arcane Crystal"), new WandStats(0, 0, 100))))));
