...
public class ModItems implements RegistryClass {
    ...
    public static final ItemRegistryEntry<Item> ARTISAN_RELIC = HELPER.register("artisan_relic", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.ARTISAN_RELIC));
    public static final ItemRegistryEntry<Item> CRESCENT_MOON = HELPER.register("crescent_moon", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.CRESCENT_MOON));
    public static final ItemRegistryEntry<Item> CRIMSON_STONE = HELPER.register("crimson_stone", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.CRIMSON_STONE));
    public static final ItemRegistryEntry<Item> SOUL_CRIMSON_STONE = HELPER.register("soul_crimson_stone", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.SOUL_CRIMSON_STONE));
    public static final ItemRegistryEntry<Item> ELEMENTARIUM = HELPER.register("elementarium", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.ELEMENTARIUM));
    public static final ItemRegistryEntry<Item> DIVINE_PACT = HELPER.register("divine_pact", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.DIVINE_PACT));
    public static final ItemRegistryEntry<Item> MALEDICTUS_PACT = HELPER.register("maledictus_pact", Item::new, () -> new Item.Properties().component(ModDataComponents.ENHANCER.value(), ModEnhancerDefinitions.MALEDICTUS_PACT));
    ...
    public static final ItemRegistryEntry<PickaxeItem> GOLDEN_BLACKSMITH_GAVEL = HELPER.register("golden_blacksmith_gavel", (properties) -> new PickaxeItem(ToolMaterial.GOLD, 1.0F, -2.8F, properties), () -> new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL));
    public static final ItemRegistryEntry<PickaxeItem> IRON_BLACKSMITH_GAVEL = HELPER.register("iron_blacksmith_gavel", (properties) -> new PickaxeItem(ToolMaterial.IRON, 1.0F, -2.8F, properties), () -> new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL));
    public static final ItemRegistryEntry<PickaxeItem> DIAMOND_BLACKSMITH_GAVEL = HELPER.register("diamond_blacksmith_gavel", (properties) -> new PickaxeItem(ToolMaterial.DIAMOND, 1.0F, -2.8F, properties), () -> new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL));
    public static final ItemRegistryEntry<PickaxeItem> NETHERITE_BLACKSMITH_GAVEL = HELPER.register("netherite_blacksmith_gavel", (properties) -> new PickaxeItem(ToolMaterial.NETHERITE, 1.0F, -2.8F, properties), () -> new Item.Properties().stacksTo(1).fireResistant().component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL));
...
//    public static final ItemRegistryEntry<Item> REINFORCED_DEORUM_HOE = HELPER.register("reinforced_deorum_hoe", () -> new HoeItem(FAToolMaterials.REINFORCED_DEORUM, new Item.Properties()));
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_HELMET = HELPER.register("draco_arcanus_helmet", (properties) -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.HELMET, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_CHESTPLATE = HELPER.register("draco_arcanus_chestplate", (properties) -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.CHESTPLATE, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_LEGGINGS = HELPER.register("draco_arcanus_leggings", (properties) -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.LEGGINGS, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_BOOTS = HELPER.register("draco_arcanus_boots", (properties) -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.BOOTS, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> TYR_HELMET = HELPER.register("tyr_helmet", (properties) -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.HELMET, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> TYR_CHESTPLATE = HELPER.register("tyr_chestplate", (properties) -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.CHESTPLATE, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> TYR_LEGGINGS = HELPER.register("tyr_leggings", (properties) -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.LEGGINGS, properties), Item.Properties::new);
    public static final ItemRegistryEntry<Item> TYR_BOOTS = HELPER.register("tyr_boots", (properties) -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.BOOTS, properties), Item.Properties::new);
