...
public class ModItems implements RegistryClass {
    ...
    public static final ItemRegistryEntry<Item> CONTAINMENT_CAPSULE = HELPER.register("containment_capsule", Item::new, () -> new Item.Properties().stacksTo(1).requiredFeatures(ForbiddenArcanus.PREVIEW));
    public static final ItemRegistryEntry<Item> ENCAPSULATED_BLACK_HOLE = HELPER.register("encapsulated_black_hole", properties -> new BlockItem(ModBlocks.BLACK_HOLE.get(), properties), () -> new Item.Properties().stacksTo(1).requiredFeatures(ForbiddenArcanus.PREVIEW));
