...
public class ModItems implements RegistryClass {
    ...
    public static final ItemRegistryEntry<Item> BAT_WING = HELPER.register("bat_wing", () -> new Item(new Item.Properties().food(ModFoods.BAT_WING, FAConsumables.BAT_WING)));
    public static final ItemRegistryEntry<Item> BAT_SOUP = HELPER.register("bat_soup", () -> new Item(new Item.Properties().stacksTo(1).food(ModFoods.BAT_SOUP, FAConsumables.BAT_SOUP)));
    ...
    public static final ItemRegistryEntry<PickaxeItem> WOODEN_BLACKSMITH_GAVEL = HELPER.register("wooden_blacksmith_gavel", () -> new PickaxeItem(ToolMaterial.WOOD, 1.0F, -2.8F, new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL)));
    public static final ItemRegistryEntry<PickaxeItem> STONE_BLACKSMITH_GAVEL = HELPER.register("stone_blacksmith_gavel", () -> new PickaxeItem(ToolMaterial.STONE, 1.0F, -2.8F, new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL)));
    public static final ItemRegistryEntry<PickaxeItem> GOLDEN_BLACKSMITH_GAVEL = HELPER.register("golden_blacksmith_gavel", () -> new PickaxeItem(ToolMaterial.GOLD, 1.0F, -2.8F, new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL)));
    public static final ItemRegistryEntry<PickaxeItem> IRON_BLACKSMITH_GAVEL = HELPER.register("iron_blacksmith_gavel", () -> new PickaxeItem(ToolMaterial.IRON, 1.0F, -2.8F, new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL)));
    public static final ItemRegistryEntry<PickaxeItem> DIAMOND_BLACKSMITH_GAVEL = HELPER.register("diamond_blacksmith_gavel", () -> new PickaxeItem(ToolMaterial.DIAMOND, 1.0F, -2.8F, new Item.Properties().stacksTo(1).component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL)));
    public static final ItemRegistryEntry<PickaxeItem> NETHERITE_BLACKSMITH_GAVEL = HELPER.register("netherite_blacksmith_gavel", () -> new PickaxeItem(ToolMaterial.NETHERITE, 1.0F, -2.8F, new Item.Properties().stacksTo(1).fireResistant().component(ModDataComponents.RITUAL_STARTER, RitualStarter.BLACKSMITH_GAVEL)));
...
//    public static final ItemRegistryEntry<Item> REINFORCED_DEORUM_HOE = HELPER.register("reinforced_deorum_hoe", () -> new HoeItem(FAToolMaterials.REINFORCED_DEORUM, new Item.Properties()));
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_HELMET = HELPER.register("draco_arcanus_helmet", () -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.HELMET, new Item.Properties()));
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_CHESTPLATE = HELPER.register("draco_arcanus_chestplate", () -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.CHESTPLATE, new Item.Properties()));
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_LEGGINGS = HELPER.register("draco_arcanus_leggings", () -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.LEGGINGS, new Item.Properties()));
    public static final ItemRegistryEntry<Item> DRACO_ARCANUS_BOOTS = HELPER.register("draco_arcanus_boots", () -> new ArmorItem(FAArmorMaterials.DRACO_ARCANUS, ArmorType.BOOTS, new Item.Properties()));
    public static final ItemRegistryEntry<Item> TYR_HELMET = HELPER.register("tyr_helmet", () -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.HELMET, new Item.Properties()));
    public static final ItemRegistryEntry<Item> TYR_CHESTPLATE = HELPER.register("tyr_chestplate", () -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.CHESTPLATE, new Item.Properties()));
    public static final ItemRegistryEntry<Item> TYR_LEGGINGS = HELPER.register("tyr_leggings", () -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.LEGGINGS, new Item.Properties()));
    public static final ItemRegistryEntry<Item> TYR_BOOTS = HELPER.register("tyr_boots", () -> new ArmorItem(FAArmorMaterials.TYR, ArmorType.BOOTS, new Item.Properties()));
