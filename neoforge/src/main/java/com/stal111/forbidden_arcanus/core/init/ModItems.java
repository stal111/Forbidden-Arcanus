...
public class ModItems implements RegistryClass {
    ...
    public static final ItemRegistryEntry<Item> ENCAPSULATED_BLACK_HOLE = HELPER.register("encapsulated_black_hole", properties -> new BlockItem(ModBlocks.BLACK_HOLE.get(), properties), () -> new Item.Properties().stacksTo(1));
...
//    public static final ItemRegistryEntry<BoatItem> EDELWOOD_CHEST_BOAT = HELPER.register("edelwood_chest_boat", () -> new ModBoatItem(true, ModBoat.Type.EDELWOOD, new Item.Properties().stacksTo(1)));
    ...
    public static final ItemRegistryEntry<MagicWandItem> OAK_WAND = HELPER.register("oak_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> SPRUCE_WAND = HELPER.register("spruce_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> BIRCH_WAND = HELPER.register("birch_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> JUNGLE_WAND = HELPER.register("jungle_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> ACACIA_WAND = HELPER.register("acacia_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> DARK_OAK_WAND = HELPER.register("dark_oak_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> MANGROVE_WAND = HELPER.register("mangrove_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> CHERRY_WAND = HELPER.register("cherry_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> PALE_OAK_WAND = HELPER.register("pale_oak_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> BAMBOO_WAND = HELPER.register("bamboo_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> CRIMSON_WAND = HELPER.register("crimson_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> WARPED_WAND = HELPER.register("warped_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> AURUM_WAND = HELPER.register("aurum_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
    public static final ItemRegistryEntry<MagicWandItem> EDELWOOD_WAND = HELPER.register("edelwood_wand", MagicWandItem::new, () -> new Item.Properties().stacksTo(1).component(ModDataComponents.SHOWS_AUREAL_METER, Unit.INSTANCE).component(ModDataComponents.AUREAL_COST, new AurealCost(5)));
