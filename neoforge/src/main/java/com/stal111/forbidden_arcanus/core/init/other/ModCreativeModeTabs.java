    ...
    public static final RegistryEntry<CreativeModeTab, CreativeModeTab> MAIN = HELPER.register("main", ValhelsiaCore.INSTANCE.createCreativeTab(builder -> {
                builder.icon(() -> new ItemStack(ModBlocks.HEPHAESTUS_FORGE.get()))
                        ...
                        .displayItems((_, output) -> {
                            ...
                            output.accept(ModBlocks.ASTERITE_DEBRIS.get());
                            ...
                            output.accept(ModBlocks.ASTERITE_BLOCK.get());
                            output.accept(ModBlocks.STELLARITE_BLOCK.get());
                            output.accept(ModBlocks.DEORUM_BLOCK.get());
                            output.accept(ModBlocks.STYGIAN_STEEL_BLOCK.get());
                            ...
                            output.accept(ModItems.ASTERITE_CHUNK.get());
                            ...
                            output.accept(ModItems.ASTERITE_INGOT.get());
                            output.accept(ModItems.STYGIAN_STEEL_INGOT.get());
...
//                            output.accept(ModItems.DRACO_ARCANUS_HOE.get());
                            ...
                            output.accept(ModItems.OAK_WAND.get());
                            output.accept(ModItems.SPRUCE_WAND.get());
                            output.accept(ModItems.BIRCH_WAND.get());
                            output.accept(ModItems.JUNGLE_WAND.get());
                            output.accept(ModItems.ACACIA_WAND.get());
                            output.accept(ModItems.DARK_OAK_WAND.get());
                            output.accept(ModItems.MANGROVE_WAND.get());
                            output.accept(ModItems.CHERRY_WAND.get());
                            output.accept(ModItems.PALE_OAK_WAND.get());
                            output.accept(ModItems.BAMBOO_WAND.get());
                            output.accept(ModItems.CRIMSON_WAND.get());
                            output.accept(ModItems.WARPED_WAND.get());
                            output.accept(ModItems.AURUM_WAND.get());
                            output.accept(ModItems.EDELWOOD_WAND.get());
