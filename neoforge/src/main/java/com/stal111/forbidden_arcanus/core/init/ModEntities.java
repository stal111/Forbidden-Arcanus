...
public class ModEntities implements RegistryClass {
    ...
    public static final RegistryEntry<EntityType<?>, EntityType<AurealMissile>> AUREAL_MISSILE = HELPER.register("aureal_missile", EntityType.Builder.<AurealMissile>of(AurealMissile::new, MobCategory.MISC).sized(0.4F, 0.4F).clientTrackingRange(4).updateInterval(10));
