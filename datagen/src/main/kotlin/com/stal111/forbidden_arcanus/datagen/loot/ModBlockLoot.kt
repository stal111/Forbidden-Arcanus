...
class ModBlockLoot(
    ...
    override fun generate() {
        ...
        dropSelf(ModBlocks.HEPHAESTUS_FORGE_TIER_1.get())
        dropSelf(ModBlocks.HEPHAESTUS_FORGE_TIER_2.get())
        dropSelf(ModBlocks.HEPHAESTUS_FORGE_TIER_3.get())
        dropSelf(ModBlocks.HEPHAESTUS_FORGE_TIER_4.get())
        dropSelf(ModBlocks.HEPHAESTUS_FORGE_TIER_5.get())
