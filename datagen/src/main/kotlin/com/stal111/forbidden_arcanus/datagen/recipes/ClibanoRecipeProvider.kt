...
//                1.0f,
//                100
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.ARCANE_CRYSTAL), CHANCE_33))
...
//                0.4f,
//                80
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.ARCANE_CRYSTAL), CHANCE_10))
...
//                0.5f,
//                100
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.RUNE), CHANCE_10))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.COAL), CHANCE_33))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.IRON), CHANCE_33))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.GOLD), CHANCE_20))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.COPPER), CHANCE_33))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.LAPIS_LAZULI), CHANCE_20))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.DIAMOND), CHANCE_10))
...
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.EMERALD), CHANCE_10))
//                .unlockedBy(ItemTags.EMERALD_ORES)
//        )
//        this.add(
//            this.clibanoRecipe(Items.NETHERITE_SCRAP, Ingredient.of(Blocks.ANCIENT_DEBRIS), 1.0f, 100)
//                .residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.NETHERITE), CHANCE_05))
...
//                0.35f,
//                100
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.IRON), CHANCE_33)).unlockedBy(
...
//                0.5f,
//                100
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.GOLD), CHANCE_20)).unlockedBy(
...
//                0.35f,
//                100
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.COPPER), CHANCE_33)).unlockedBy(
//                Tags.Items.RAW_MATERIALS_COPPER
//            ), "clibano_combustion/copper_ingot_from_clibano_combusting_raw_copper"
//        )
//
//        val artisanRelic: Holder<EnhancerDefinition?> = enhancerLookup.getOrThrow(ModEnhancerDefinitions.ARTISAN_RELIC)
//
//        this.add(
//            this.clibanoRecipe(
...
//                0.5f,
//                100
//            ).residue(ResidueChance(residueLookup.getOrThrow(ModResidueTypes.COPPER), CHANCE_33)).enhancer(artisanRelic)
