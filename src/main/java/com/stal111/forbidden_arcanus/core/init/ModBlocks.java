...
public class ModBlocks implements RegistryClass {
    ...
    public static final BlockRegistryObject<PedestalBlock> ARCANE_DARKSTONE_PEDESTAL = HELPER.create("arcane_darkstone_pedestal", () -> new PedestalBlock(Block.Properties.copy(Blocks.STONE).strength(4.5F, 8.0F).noOcclusion())).withItem();
