...
public class ModStructureFeatures {
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> NIPA = register("nipa", ModStructures.NIPA.get().configured(new NipaConfig(0.3F), ModTags.Biomes.HAS_NIPA));
    public static final Holder<ConfiguredStructureFeature<?, ?>> NIPA_ALWAYS_FLOATING = register("nipa_always_floating", ModStructures.NIPA.get().configured(new NipaConfig(1.0F), ModTags.Biomes.HAS_NIPA_ALWAYS_FLOATING));
