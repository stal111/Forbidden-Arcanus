...
public class ModBlockEntities implements RegistryClass {
    ...
    public static final RegistryEntry<BlockEntityType<?>, BlockEntityType<EssenceUtremJarBlockEntity>> ESSENCE_UTREM_JAR = HELPER.register("essence_utrem_jar", () -> BlockEntityType.Builder.of(EssenceUtremJarBlockEntity::new, ModBlocks.ESSENCE_UTREM_JAR.get()).build(null));
