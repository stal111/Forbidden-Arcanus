...
public class CompostableRegistry {
    ...
    public static void register() {
        HELPER.register03(ModBlocks.CHERRYWOOD_LEAVES.get());
        HELPER.register03(ModBlocks.CHERRYWOOD_LEAF_CARPET.get());
        HELPER.register03(ModBlocks.MYSTERYWOOD_LEAVES.get());
        HELPER.register03(ModBlocks.NUGGETY_MYSTERYWOOD_LEAVES.get());
        HELPER.register03(ModBlocks.FUNGYSS.get());
        HELPER.register03(ModBlocks.CHERRYWOOD_SAPLING.get());
        HELPER.register03(ModBlocks.MYSTERYWOOD_SAPLING.get());
