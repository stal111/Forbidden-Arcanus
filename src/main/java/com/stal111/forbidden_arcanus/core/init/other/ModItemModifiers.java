...
public class ModItemModifiers implements RegistryClass {
    ...
    public static final RegistryEntry<ItemModifier, ItemModifier> FIERY = HELPER.register("fiery", () -> new ItemModifier(TOOL_PREDICATE.get(), ModTags.Items.FIERY_INCOMPATIBLE, ModTags.Enchantments.FIERY_INCOMPATIBLE, FastColor.ARGB32.color(255, 255, 143, 0), FastColor.ARGB32.color(255, 88, 6, 6)));
    ...
    public static final RegistryEntry<ItemModifier, ItemModifier> DEMOLISHING = HELPER.register("demolishing", () -> new ItemModifier(TOOL_PREDICATE.get(), ModTags.Items.DEMOLISHING_INCOMPATIBLE, ModTags.Enchantments.DEMOLISHING_INCOMPATIBLE, FastColor.ARGB32.color(255, 111, 84, 80), FastColor.ARGB32.color(255, 78, 58, 39)));
