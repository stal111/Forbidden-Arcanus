...
public class ModPOITypes implements RegistryClass {
    ...
    private static final List<RegistryEntry<? extends Block>> HEPHAESTUS_FORGE_BLOCKS = ImmutableList.of(
