...
public class ModConfiguredFeatures implements RegistryClass {
    ...
    public static final RegistryObject<ConfiguredFeature<TreeConfiguration, ?>> SMALL_CHERRYWOOD = HELPER.register("small_cherrywood", () -> new ConfiguredFeature<>(Feature.TREE, new CherryTreeConfiguration(BlockStateProvider.simple(ModBlocks.CHERRY_LOG.get()), BlockStateProvider.simple(ModBlocks.THIN_CHERRY_LOG.get()), new CherryTrunkPlacer(3, 1, 1), BlockStateProvider.simple(ModBlocks.CHERRY_LEAVES.get()), new CherryFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2))));
    public static final RegistryObject<ConfiguredFeature<TreeConfiguration, ?>> LARGE_CHERRYWOOD = HELPER.register("large_cherrywood", () -> new ConfiguredFeature<>(Feature.TREE, new CherryTreeConfiguration(BlockStateProvider.simple(ModBlocks.CHERRY_LOG.get()), BlockStateProvider.simple(ModBlocks.THIN_CHERRY_LOG.get()), new CherryTrunkPlacer(4, 2, 2), BlockStateProvider.simple(ModBlocks.CHERRY_LEAVES.get()), new CherryFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2))));
