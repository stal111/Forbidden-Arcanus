...
public class ModEnhancerEffectConditions implements RegistryClass {
    ...
    public static final RegistryEntry<EffectConditionType<TimeCondition>> TIME = register("time", TimeCondition.CODEC);

    public static <T extends EffectCondition> RegistryEntry<EffectConditionType<T>> register(String name, Codec<T> codec) {
