...
public class ModItems implements RegistryClass {
    ...
    public static final RegistryObject<Item> DEORUM_INGOT = HELPER.register("deorum_ingot", () -> new Item(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_NUGGET = HELPER.register("deorum_nugget", () -> new Item(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    ...
    public static final RegistryObject<Item> ENCHANTED_SOUL = HELPER.register("enchanted_soul", () -> new Item(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    ...
    public static final RegistryObject<Item> WAX = HELPER.register("wax", () -> new Item(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
     public static final RegistryObject<FerrogneticMixtureItem> FERROGNETIC_MIXTURE = HELPER.register("ferrognetic_mixture", () -> new FerrogneticMixtureItem(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    ...
    public static final RegistryObject<LensOfVeritatisItem> LENS_OF_VERITATIS = HELPER.register("lens_of_veritatis", () -> new LensOfVeritatisItem(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
    ...
    public static final RegistryObject<ObsidianSkullItem> OBSIDIAN_SKULL = HELPER.register("obsidian_skull", () -> new ObsidianSkullItem(ModBlocks.OBSIDIAN_SKULL.get(), ModBlocks.OBSIDIAN_WALL_SKULL.get(), false, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1).rarity(Rarity.UNCOMMON).fireResistant()));
    ...
    public static final RegistryObject<ObsidianSkullItem> ETERNAL_OBSIDIAN_SKULL = HELPER.register("eternal_obsidian_skull", () -> new ObsidianSkullItem(ModBlocks.ETERNAL_OBSIDIAN_SKULL.get(), ModBlocks.ETERNAL_OBSIDIAN_WALL_SKULL.get(), true, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
    ...
    public static final RegistryObject<SplashAurealBottleItem> SPLASH_AUREAL_BOTTLE = HELPER.register("splash_aureal_bottle", () -> new SplashAurealBottleItem(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(16)));
    ...
    public static final RegistryObject<BlacksmithGavelItem> NETHERITE_BLACKSMITH_GAVEL = HELPER.register("netherite_blacksmith_gavel", () -> new BlacksmithGavelItem(Tiers.NETHERITE, 7, -3.25F, 60, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1).fireResistant()));
    public static final RegistryObject<BlacksmithGavelItem> DEORUM_BLACKSMITH_GAVEL = HELPER.register("deorum_blacksmith_gavel", () -> new BlacksmithGavelItem(ModTiers.DEORUM, 7, -3.25F, 15, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
    public static final RegistryObject<BlacksmithGavelItem> REINFORCED_DEORUM_BLACKSMITH_GAVEL = HELPER.register("reinforced_deorum_blacksmith_gavel", () -> new BlacksmithGavelItem(ModTiers.REINFORCED_DEORUM, 7, -3.25F, 80, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
    ...
    public static final RegistryObject<Item> TERRASTOMP_PRISM = HELPER.register("terrastomp_prism", () -> new Item(new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    ...
    public static final RegistryObject<EdelwoodMobBucketItem> EDELWOOD_BEE_BUCKET = HELPER.register("edelwood_bee_bucket", () -> new EdelwoodMobBucketItem(() -> EntityType.BEE, () -> Fluids.EMPTY, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
    ...
    public static final RegistryObject<EdelwoodMobBucketItem> EDELWOOD_STRIDER_BUCKET = HELPER.register("edelwood_strider_bucket", () -> new EdelwoodMobBucketItem(() -> EntityType.STRIDER, () -> Fluids.LAVA, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
    ...
    public static final RegistryObject<EdelwoodMobBucketItem> EDELWOOD_ALLAY_BUCKET = HELPER.register("edelwood_allay_bucket", () -> new EdelwoodMobBucketItem(() -> EntityType.ALLAY, () -> Fluids.EMPTY, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
    ...
    public static final RegistryObject<Item> DEORUM_SWORD = HELPER.register("deorum_sword", () -> new SwordItem(ModTiers.DEORUM, 3, -2.4F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_SHOVEL = HELPER.register("deorum_shovel", () -> new ShovelItem(ModTiers.DEORUM, 1.5F, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_PICKAXE = HELPER.register("deorum_pickaxe", () -> new PickaxeItem(ModTiers.DEORUM, 1, -2.8F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_AXE = HELPER.register("deorum_axe", () -> new AxeItem(ModTiers.DEORUM, 5, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_HOE = HELPER.register("deorum_hoe", () -> new HoeItem(ModTiers.DEORUM, -3, 0, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_DEORUM_SWORD = HELPER.register("reinforced_deorum_sword", () -> new SwordItem(ModTiers.REINFORCED_DEORUM, 3, -2.4F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_DEORUM_SHOVEL = HELPER.register("reinforced_deorum_shovel", () -> new ShovelItem(ModTiers.REINFORCED_DEORUM, 1.5F, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_DEORUM_PICKAXE = HELPER.register("reinforced_deorum_pickaxe", () -> new PickaxeItem(ModTiers.REINFORCED_DEORUM, 1, -2.8F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_DEORUM_AXE = HELPER.register("reinforced_deorum_axe", () -> new AxeItem(ModTiers.REINFORCED_DEORUM, 5, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_DEORUM_HOE = HELPER.register("reinforced_deorum_hoe", () -> new HoeItem(ModTiers.REINFORCED_DEORUM, -3, 0, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    ...
    public static final RegistryObject<Item> DEORUM_HELMET = HELPER.register("deorum_helmet", () -> new ArmorItem(ModArmorMaterials.DEORUM, EquipmentSlot.HEAD, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_CHESTPLATE = HELPER.register("deorum_chestplate", () -> new ArmorItem(ModArmorMaterials.DEORUM, EquipmentSlot.CHEST, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_LEGGINGS = HELPER.register("deorum_leggings", () -> new ArmorItem(ModArmorMaterials.DEORUM, EquipmentSlot.LEGS, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DEORUM_BOOTS = HELPER.register("deorum_boots", () -> new ArmorItem(ModArmorMaterials.DEORUM, EquipmentSlot.FEET, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
