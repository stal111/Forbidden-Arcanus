...
public class ModItems implements RegistryClass {
    ...
    public static final ItemRegistryEntry<Item> XPETRIFIED_ORB = HELPER.register("xpetrified_orb", () -> new XpetrifiedOrbItem(new Item.Properties().stacksTo(16)));
    ...
    public static final ItemRegistryEntry<Item> SOUL = HELPER.register("soul", () -> new Item(new Item.Properties()));
    public static final ItemRegistryEntry<DarkSoulItem> CORRUPT_SOUL = HELPER.register("corrupt_soul", () -> new DarkSoulItem(new Item.Properties()));
    public static final ItemRegistryEntry<Item> ENCHANTED_SOUL = HELPER.register("enchanted_soul", () -> new Item(new Item.Properties()));
    ...
    public static final ItemRegistryEntry<Item> AUREAL_TANK = HELPER.register("aureal_tank", () -> new AurealTankItem(new Item.Properties().stacksTo(1).component(ModDataComponents.ESSENCE_DATA, AurealTankItem.DEFAULT_DATA)));
    ...
    public static final ItemRegistryEntry<BlockItem> ESSENCE_UTREM_JAR = HELPER.register("essence_utrem_jar", () -> new BlockItem(ModBlocks.ESSENCE_UTREM_JAR.get(), new Item.Properties()));
    ...
    public static final ItemRegistryEntry<CapacityBucketItem> EDELWOOD_WATER_BUCKET = HELPER.register("edelwood_water_bucket", () -> new CapacityBucketItem(() -> Fluids.WATER, 4, BucketFamily.EDELWOOD_BUCKET, new Item.Properties().stacksTo(1)));
    public static final ItemRegistryEntry<CapacityBucketItem> EDELWOOD_LAVA_BUCKET = HELPER.register("edelwood_lava_bucket", () -> new CapacityBucketItem(() -> Fluids.LAVA, 3, BucketFamily.EDELWOOD_BUCKET, new Item.Properties().stacksTo(1)));
    public static final ItemRegistryEntry<CapacityMilkBucketItem> EDELWOOD_MILK_BUCKET = HELPER.register("edelwood_milk_bucket", () -> new CapacityMilkBucketItem(BucketFamily.EDELWOOD_BUCKET, new Item.Properties().stacksTo(1)));
    public static final ItemRegistryEntry<SolidCapacityBucketItem> EDELWOOD_POWDER_SNOW_BUCKET = HELPER.register("edelwood_powder_snow_bucket", () -> new SolidCapacityBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, BucketFamily.EDELWOOD_BUCKET, new Item.Properties().stacksTo(1)));
