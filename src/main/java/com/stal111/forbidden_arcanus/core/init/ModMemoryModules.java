...
public class ModMemoryModules implements RegistryClass {
    ...
    public static final MappedRegistryHelper<MemoryModuleType<?>> HELPER = ForbiddenArcanus.REGISTRY_MANAGER.getMappedHelper(ForgeRegistries.Keys.MEMORY_MODULE_TYPES);
