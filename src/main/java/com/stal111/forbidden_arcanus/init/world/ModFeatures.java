...
public class ModFeatures {
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> PETRIFIED_ROOT = register("petrified_root", () -> new PetrifiedRootFeature(NoneFeatureConfiguration.CODEC));
