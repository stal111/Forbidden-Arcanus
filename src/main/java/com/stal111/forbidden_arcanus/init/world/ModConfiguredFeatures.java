...
public class ModConfiguredFeatures {
    ...
    public static final class FillerBlockTypes {
        protected static final RuleTest DARKSTONE = new BlockMatchTest(NewModBlocks.DARKSTONE.get());
    }
    ...
    public static final class States {
        ...
        protected static final BlockState ARCANE_CRYSTAL_ORE = NewModBlocks.ARCANE_CRYSTAL_ORE.get().defaultBlockState();
        protected static final BlockState RUNESTONE = ModBlocks.RUNESTONE.getBlock().defaultBlockState();
        protected static final BlockState DARKSTONE = NewModBlocks.DARKSTONE.get().defaultBlockState();
        protected static final BlockState ARCANE_GILDED_DARKSTONE = NewModBlocks.ARCANE_GILDED_DARKSTONE.get().defaultBlockState();
        protected static final BlockState DARK_RUNESTONE = ModBlocks.DARK_RUNESTONE.getBlock().defaultBlockState();
        protected static final BlockState STELLA_ARCANUM = ModBlocks.STELLA_ARCANUM.getBlock().defaultBlockState();
        protected static final BlockState XPETRIFIED_ORE = ModBlocks.XPETRIFIED_ORE.getBlock().defaultBlockState();
        protected static final BlockState CHERRYWOOD_LOG = ModBlocks.CHERRYWOOD_LOG.getBlock().defaultBlockState();
        protected static final BlockState CHERRYWOOD_LEAVES = ModBlocks.CHERRYWOOD_LEAVES.getBlock().defaultBlockState();
        protected static final BlockState CHERRYWOOD_SAPLING = ModBlocks.CHERRYWOOD_SAPLING.getBlock().defaultBlockState();
        protected static final BlockState MYSTERYWOOD_LOG = ModBlocks.MYSTERYWOOD_LOG.getBlock().defaultBlockState();
        protected static final BlockState MYSTERYWOOD_LEAVES = ModBlocks.MYSTERYWOOD_LEAVES.getBlock().defaultBlockState();
        protected static final BlockState MYSTERYWOOD_SAPLING = ModBlocks.MYSTERYWOOD_SAPLING.getBlock().defaultBlockState();
        protected static final BlockState YELLOW_ORCHID = ModBlocks.YELLOW_ORCHID.getBlock().defaultBlockState();
        protected static final BlockState EDELWOOD_LOG = ModBlocks.EDELWOOD_LOG.getBlock().defaultBlockState().setValue(EdelwoodLogBlock.LEAVES, true);
    }
}
