...
public class ModConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> EDELWOOD_LOG = register("edelwood_log", Feature.RANDOM_PATCH.withConfiguration(Configs.EDELWOOD_LOG).func_242731_b(3).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.treeList))));
    public static final ConfiguredFeature<?, ?> PETRIFIED_ROOT = register("petrified_root", ModFeatures.PETRIFIED_ROOT.get().withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).range(50).square().func_242731_b(50).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.treeList))));

    public static final ConfiguredFeature<?, ?> CHERRYWOOD_TREES = register("trees_cherrywood", CHERRYWOOD.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(0, 0.1F, 1))).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.treeList))));
