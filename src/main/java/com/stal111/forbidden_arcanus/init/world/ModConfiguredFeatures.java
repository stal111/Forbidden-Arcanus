...
public class ModConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ARCANE_CRYSTAL_ORE = register("ore_arcane_crystal", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.ARCANE_CRYSTAL_ORE, WorldGenConfig.ARCANE_CRYSTAL_ORE_MAX_VEIN_SIZE.get())).range(WorldGenConfig.ARCANE_CRYSTAL_ORE_MAX_HEIGHT.get()).square().func_242731_b(WorldGenConfig.ARCANE_CRYSTAL_ORE_COUNT.get()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<?, ?> RUNESTONE = register("ore_rune", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.RUNESTONE, WorldGenConfig.RUNESTONE_MAX_VEIN_SIZE.get())).range(WorldGenConfig.RUNESTONE_MAX_HEIGHT.get()).square().func_242731_b(WorldGenConfig.RUNESTONE_COUNT.get()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<?, ?> DARKSTONE = register("ore_darkstone", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.DARKSTONE, WorldGenConfig.DARKSTONE_MAX_VEIN_SIZE.get())).range(WorldGenConfig.DARKSTONE_MAX_HEIGHT.get()).square().func_242731_b(WorldGenConfig.DARKSTONE_COUNT.get()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<?, ?> ARCANE_GILDED_DARKSTONE = register("ore_arcane_gilded_darkstone", Feature.ORE.withConfiguration(new OreFeatureConfig(FillerBlockTypes.DARKSTONE, States.ARCANE_GILDED_DARKSTONE, WorldGenConfig.ARCANE_CRYSTAL_ORE_MAX_VEIN_SIZE.get())).range(WorldGenConfig.ARCANE_GILDED_DARKSTONE_MAX_HEIGHT.get()).square().func_242731_b(WorldGenConfig.ARCANE_GILDED_DARKSTONE_COUNT.get()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<?, ?> DARK_RUNESTONE = register("ore_dark_rune", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.DARK_RUNESTONE, WorldGenConfig.DARK_RUNESTONE_MAX_VEIN_SIZE.get())).range(WorldGenConfig.DARK_RUNESTONE_MAX_HEIGHT.get()).square().func_242731_b(WorldGenConfig.DARK_RUNESTONE_COUNT.get()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<?, ?> STELLA_ARCANUM = register("ore_stella_arcanum", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.STELLA_ARCANUM, WorldGenConfig.STELLA_ARCANUM_MAX_VEIN_SIZE.get())).range(WorldGenConfig.STELLA_ARCANUM_MAX_HEIGHT.get()).square().func_242731_b(WorldGenConfig.STELLA_ARCANUM_COUNT.get()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<?, ?> XPETRIFIED_ORE = register("ore_xpetrified", Feature.EMERALD_ORE.withConfiguration(new ReplaceBlockConfig(States.STONE, States.XPETRIFIED_ORE)).withPlacement(Placement.EMERALD_ORE.configure(IPlacementConfig.NO_PLACEMENT_CONFIG)).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getOreWhitelist(), WorldGenConfig.getOreBlacklist()))));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CHERRYWOOD = (ConfiguredFeature<BaseTreeFeatureConfig, ?>) register("cherrywood", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.CHERRYWOOD_LOG), new SimpleBlockStateProvider(States.CHERRYWOOD_LEAVES), new AcaciaFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0)), new ForkyTrunkPlacer(5, 2, 2), new TwoLayerFeature(1, 0, 2))).setIgnoreVines().build()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MYSTERYWOOD = (ConfiguredFeature<BaseTreeFeatureConfig, ?>) register("mysterywood", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.MYSTERYWOOD_LOG), new SimpleBlockStateProvider(States.MYSTERYWOOD_LEAVES), new FancyFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(4), 4), new FancyTrunkPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0, OptionalInt.of(4)))).setIgnoreVines().func_236702_a_(Heightmap.Type.MOTION_BLOCKING).build()).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));
    public static final ConfiguredFeature<?, ?> YELLOW_ORCHID = register("flower_yellow_orchid", Feature.FLOWER.withConfiguration(Configs.YELLOW_ORCHID).withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).func_242731_b(14)).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist())));
    public static final ConfiguredFeature<?, ?> EDELWOOD_LOG = register("edelwood_log", Feature.RANDOM_PATCH.withConfiguration(Configs.EDELWOOD_LOG).func_242731_b(3).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));
    public static final ConfiguredFeature<?, ?> PETRIFIED_ROOT = register("petrified_root", ModFeatures.PETRIFIED_ROOT.get().withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).range(50).square().func_242731_b(50).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));

    public static final ConfiguredFeature<?, ?> CHERRYWOOD_TREES = register("trees_cherrywood", CHERRYWOOD.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig((int) 0.3F, 0.1F, 1))).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));
    public static final ConfiguredFeature<?, ?> MYSTERYWOOD_TREES = register("trees_mysterywood", MYSTERYWOOD.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig((int) 0.8F, 0.1F, 1))).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));

    public static final ConfiguredFeature<?, ?> BIG_FUNGYSS_0 = register("big_fungyss_0", ModFeatures.BIG_FUNGYSS.get().withConfiguration(new BigFungyssFeatureConfig(new SimpleBlockStateProvider(NewModBlocks.FUNGYSS_BLOCK.get().getDefaultState().with(HugeMushroomBlock.DOWN, false)), new SimpleBlockStateProvider(NewModBlocks.FUNGYSS_STEM.get().getDefaultState()), new SimpleBlockStateProvider(NewModBlocks.FUNGYSS_HYPHAE.get().getDefaultState()), 0)).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));
    public static final ConfiguredFeature<?, ?> BIG_FUNGYSS_1 = register("big_fungyss_1", ModFeatures.BIG_FUNGYSS.get().withConfiguration(new BigFungyssFeatureConfig(new SimpleBlockStateProvider(NewModBlocks.FUNGYSS_BLOCK.get().getDefaultState().with(HugeMushroomBlock.DOWN, false)), new SimpleBlockStateProvider(NewModBlocks.FUNGYSS_STEM.get().getDefaultState()), new SimpleBlockStateProvider(NewModBlocks.FUNGYSS_HYPHAE.get().getDefaultState()), 1)).withPlacement(ModFeatures.DIMENSION_PLACEMENT.get().configure(new DimensionConfig(WorldGenConfig.getTreeWhitelist(), WorldGenConfig.getTreeBlacklist()))));
