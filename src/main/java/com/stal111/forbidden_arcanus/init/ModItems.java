...
public enum ModItems {
    ...
    BAT_SOUP(new SoupItem(properties().food(build(7, 0.7F, new EffectInstance(Effects.NIGHT_VISION, 240, 0), 1.0F)))),
    ...
    //EDELWOOD_BUCKET(new EdelwoodBucketItem(Fluids.EMPTY, properties())),
    //EDELWOOD_WATER_BUCKET(new EdelwoodBucketItem(Fluids.WATER, properties())),
    //EDELWOOD_LAVA_BUCKET(new EdelwoodBucketItem(Fluids.LAVA, properties())),
    ...
    MYSTICAL_DAGGER(new MysticalDaggerItem(ModItemTier.MYSTICAL_DAGGER, 2.5F, -0.6F, properties())),
