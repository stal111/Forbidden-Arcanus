...
public class ModItems {
    ...
    public static final RegistryObject<Item> EDELWOOD_BUCKET = register("edelwood_bucket", () -> new EdelwoodBucketItem(Fluids.EMPTY, 0, properties(16)));
    public static final RegistryObject<Item> EDELWOOD_WATER_BUCKET = register("edelwood_water_bucket", () -> new EdelwoodBucketItem(Fluids.WATER, 4, properties(1).containerItem(EDELWOOD_BUCKET.get())));
    public static final RegistryObject<Item> EDELWOOD_LAVA_BUCKET = register("edelwood_lava_bucket", () -> new EdelwoodBucketItem(Fluids.LAVA, 3, properties(1).containerItem(EDELWOOD_BUCKET.get())));
    public static final RegistryObject<Item> EDELWOOD_MILK_BUCKET = register("edelwood_milk_bucket", () -> new EdelwoodMilkBucketItem(4, properties(1).containerItem(EDELWOOD_BUCKET.get())));
    public static final RegistryObject<Item> EDELWOOD_PUFFERFISH_BUCKET = register("edelwood_pufferfish_bucket", () -> new EdelwoodFishBucketItem(EntityType.PUFFERFISH, Fluids.WATER, 4, properties(1)));
    public static final RegistryObject<Item> EDELWOOD_SALMON_BUCKET = register("edelwood_salmon_bucket", () -> new EdelwoodFishBucketItem(EntityType.SALMON, Fluids.WATER, 4, properties(1)));
    public static final RegistryObject<Item> EDELWOOD_COD_BUCKET = register("edelwood_cod_bucket", () -> new EdelwoodFishBucketItem(EntityType.COD, Fluids.WATER, 4, properties(1)));
    public static final RegistryObject<Item> EDELWOOD_TROPICAL_FISH_BUCKET = register("edelwood_tropical_fish_bucket", () -> new EdelwoodFishBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, 4, properties(1)));
    public static final RegistryObject<Item> EDELWOOD_MUSHROOM_STEW_BUCKET = register("edelwood_mushroom_stew_bucket", () -> new EdelwoodSoupBucketItem(8, properties(1).containerItem(EDELWOOD_BUCKET.get()).food(Foods.MUSHROOM_STEW)));
    ...
    public static final RegistryObject<Item> EDELWOOD_BEETROOT_SOUP_BUCKET = register("edelwood_beetroot_soup_bucket", () -> new EdelwoodSoupBucketItem(8, properties(1).containerItem(EDELWOOD_BUCKET.get()).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> EDELWOOD_BAT_SOUP_BUCKET = register("edelwood_bat_soup_bucket", () -> new EdelwoodSoupBucketItem(8, properties(1).containerItem(EDELWOOD_BUCKET.get()).food(build(7, 0.7F, new EffectInstance(Effects.NIGHT_VISION, 240, 0), 1.0F))));
    ...
    public static final RegistryObject<Item> EDELWOOD_SQUID_BUCKET = register("edelwood_squid_bucket", () -> new EdelwoodFishBucketItem(EntityType.SQUID, Fluids.WATER, 4, properties(1)));
