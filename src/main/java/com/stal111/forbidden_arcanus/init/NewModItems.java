...
public class NewModItems {
    ...
    public static final RegistryObject<Item> DRACO_ARCANUS_SWORD = HELPER.register("draco_arcanus_sword", () -> new SwordItem(ModItemTier.DRACO_ARCANUS, 4, -2.2F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DRACO_ARCANUS_SHOVEL = HELPER.register("draco_arcanus_shovel", () -> new ShovelItem(ModItemTier.DRACO_ARCANUS, 2.5F, -2.8F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DRACO_ARCANUS_PICKAXE = HELPER.register("draco_arcanus_pickaxe", () -> new PickaxeItem(ModItemTier.DRACO_ARCANUS, 2, -2.6F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DRACO_ARCANUS_AXE = HELPER.register("draco_arcanus_axe", () -> new AxeItem(ModItemTier.DRACO_ARCANUS, 6, -2.8F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> DRACO_ARCANUS_HOE = HELPER.register("draco_arcanus_hoe", () -> new HoeItem(ModItemTier.DRACO_ARCANUS, -4, 1, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    ...
    public static final RegistryObject<Item> ARCANE_GOLDEN_SWORD = HELPER.register("arcane_golden_sword", () -> new SwordItem(ModItemTier.ARCANE_GOLDEN, 3, -2.4F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> ARCANE_GOLDEN_SHOVEL = HELPER.register("arcane_golden_shovel", () -> new ShovelItem(ModItemTier.ARCANE_GOLDEN, 1.5F, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> ARCANE_GOLDEN_PICKAXE = HELPER.register("arcane_golden_pickaxe", () -> new PickaxeItem(ModItemTier.ARCANE_GOLDEN, 1, -2.8F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> ARCANE_GOLDEN_AXE = HELPER.register("arcane_golden_axe", () -> new AxeItem(ModItemTier.ARCANE_GOLDEN, 5, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> ARCANE_GOLDEN_HOE = HELPER.register("arcane_golden_hoe", () -> new HoeItem(ModItemTier.ARCANE_GOLDEN, -3, 0, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_ARCANE_GOLDEN_SWORD = HELPER.register("reinforced_arcane_golden_sword", () -> new SwordItem(ModItemTier.REINFORCED_ARCANE_GOLDEN, 3, -2.4F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_ARCANE_GOLDEN_SHOVEL = HELPER.register("reinforced_arcane_golden_shovel", () -> new ShovelItem(ModItemTier.REINFORCED_ARCANE_GOLDEN, 1.5F, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_ARCANE_GOLDEN_PICKAXE = HELPER.register("reinforced_arcane_golden_pickaxe", () -> new PickaxeItem(ModItemTier.REINFORCED_ARCANE_GOLDEN, 1, -2.8F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_ARCANE_GOLDEN_AXE = HELPER.register("reinforced_arcane_golden_axe", () -> new AxeItem(ModItemTier.REINFORCED_ARCANE_GOLDEN, 5, -3.0F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> REINFORCED_ARCANE_GOLDEN_HOE = HELPER.register("reinforced_arcane_golden_hoe", () -> new HoeItem(ModItemTier.REINFORCED_ARCANE_GOLDEN, -3, 0, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS)));
    public static final RegistryObject<Item> MYSTICAL_DAGGER = HELPER.register("mystical_dagger", () -> new MysticalDaggerItem(ModItemTier.MYSTICAL_DAGGER, 2.5F, -0.3F, new Item.Properties().tab(ForbiddenArcanus.FORBIDDEN_ARCANUS).stacksTo(1)));
