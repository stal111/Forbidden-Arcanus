...
public enum ModBlocks {
    ...
    IRON_CHAIN(new ChainBlock(addProperties(Material.IRON, 5.0F, 6.0F).setRequiresTool().sound(SoundType.field_235597_S_)), ModRenderType.CUTOUT),
    ARCANE_GOLDEN_CHAIN(new ChainBlock(addProperties(Material.IRON, 3.0F, 6.0F).setRequiresTool().sound(SoundType.field_235597_S_)), ModRenderType.CUTOUT),
