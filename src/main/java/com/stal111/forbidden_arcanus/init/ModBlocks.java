...
public enum ModBlocks {
    ...
    EDELWOOD_STAIRS(new StairBlock(() -> NewModBlocks.EDELWOOD_PLANKS.get().defaultBlockState(), from(Blocks.OAK_STAIRS))),
    ...
    CHERRYWOOD_STAIRS(new StairBlock(() -> NewModBlocks.CHERRYWOOD_PLANKS.get().defaultBlockState(), from(Blocks.OAK_STAIRS))),
    ...
    MYSTERYWOOD_STAIRS(new StairBlock(() -> NewModBlocks.MYSTERYWOOD_PLANKS.get().defaultBlockState(), from(Blocks.OAK_STAIRS))),
