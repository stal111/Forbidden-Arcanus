...
public enum ModBlocks {
    DARK_BEACON(new DarkBeaconBlock(from(Blocks.BEACON))),
    ...
    ARCANE_GLASS(new GlassBlock(from(Blocks.GLASS))),
    ARCANE_GLASS_PANE(new PaneBlock(from(Blocks.GLASS_PANE))),
    RUNIC_TENEBRIS_FRAME(new RunicTenebrisFrameBlock(addProperties(Material.ROCK, 2.0F, 15.0F))),
    RUNIC_TENEBRIS_CORE(new RunicTenebrisCoreBlock(addProperties(Material.ROCK, 2.0F, 15.0F))),
    DARK_STONE(new Block(addProperties(Material.ROCK, 1.5F, 6.0F))),
    DARK_RUNESTONE(new ModOreBlock(addProperties(Material.ROCK, 3.0F, 3.0F))),
    ...
    RUNIC_GLASS(new GlassBlock(from(Blocks.GLASS))),
    RUNIC_GLASS_PANE(new PaneBlock(from(Blocks.GLASS_PANE))),
    DARK_RUNIC_GLASS(new GlassBlock(from(Blocks.GLASS))),
    DARK_RUNIC_GLASS_PANE(new PaneBlock(from(Blocks.GLASS_PANE))),
    RUNESTONE(new ModOreBlock(addProperties(Material.ROCK, 3.0F, 3.0F))),
    ARCANE_CRYSTAL_ORE(new ModOreBlock(addProperties(Material.ROCK, 3.0F, 3.0F))),
    ARCANE_CRYSTAL_BLOCK(new TranslucentBlock(addProperties(Material.ROCK, 1.0F, 10.0F))),
    ...
    END_CRYSTAL_GEM(new CutoutBlock(addProperties(Material.GLASS, 1.0F, 5.0F).lightValue(15))),
    BOTTLE_BLOCK(new BottleBlock(from(Blocks.GLASS))),
    PIXIE_IN_A_BOTTLE_BLOCK(new BottleBlock(from(Blocks.GLASS).lightValue(14))),
    CORRUPTED_PIXIE_IN_A_BOTTLE_BLOCK(new BottleBlock(from(Blocks.GLASS).lightValue(9))),
    ...
    ARCANE_GOLD_DOOR(new DoorBlock(from(Blocks.GOLD_BLOCK))),
    ARCANE_DRAGON_EGG(new ArcaneDragonEggBlock(from(Blocks.DRAGON_EGG))),
    CANDLE(new CandleBlock(addProperties(Material.MISCELLANEOUS))),
    STONE_CANDELABRA(new CandelabraBlock(addProperties(Material.ROCK, 1.5F, 6.0F))),
    IRON_CANDELABRA(new CandelabraBlock(addProperties(Material.IRON, 5.0F, 6.0F))),
    ARCANE_GOLDEN_CANDELABRA(new CandelabraBlock(addProperties(Material.IRON, 3.0F, 6.0F))),
    IRON_CHAIN(new ChainBlock(addProperties(Material.IRON, 5.0F, 6.0F))),
    ARCANE_GOLDEN_CHAIN(new ChainBlock(addProperties(Material.IRON, 3.0F, 6.0F))),
    CANDLE_LAMP(new CandleLampBlock(addProperties(Material.ROCK))),
    EDELWOOD_LOG(new EdelwoodLogBlock(MaterialColor.BROWN, from(Blocks.OAK_LOG).tickRandomly())),
    ...
    EDELWOOD_TRAPDOOR(new TrapDoorBlock(from(Blocks.OAK_TRAPDOOR))),
    EDELWOOD_DOOR(new DoorBlock(from(Blocks.OAK_DOOR))),
    EDELWOOD_LADDER(new EdelwoodLadderBlock(from(Blocks.LADDER))),
    ...
    CHERRYWOOD_SAPLING(new ModSaplingBlock(new CherrywoodTree(), from(Blocks.OAK_SAPLING))),
    ...
    CHERRYWOOD_TRAPDOOR(new TrapDoorBlock(from(Blocks.OAK_TRAPDOOR))),
    CHERRYWOOD_DOOR(new DoorBlock(from(Blocks.OAK_DOOR))),
    ...
    MYSTERYWOOD_SAPLING(new ModSaplingBlock(new MysterywoodTree(), from(Blocks.OAK_SAPLING))),
    ...
    MYSTERYWOOD_TRAPDOOR(new TrapDoorBlock(from(Blocks.OAK_TRAPDOOR))),
    MYSTERYWOOD_DOOR(new DoorBlock(from(Blocks.OAK_DOOR))),
    ...
    YELLOW_ORCHID(new FlowerBlock(Effects.GLOWING, 25, from(Blocks.BLUE_ORCHID))),
    GOLDEN_ORCHID(new GoldenOrchidBlock(from(Blocks.BLUE_ORCHID).tickRandomly()), false),
    ...
    POTTED_CHERRYWOOD_SAPLING(new FlowerPotBlock(CHERRYWOOD_SAPLING.getBlock(), from(Blocks.POTTED_OAK_SAPLING)), false),
    POTTED_MYSTERYWOOD_SAPLING(new FlowerPotBlock(MYSTERYWOOD_SAPLING.getBlock(), from(Blocks.POTTED_OAK_SAPLING)), false),
    POTTED_YELLOW_ORCHID(new FlowerPotBlock(YELLOW_ORCHID.getBlock(), from(Blocks.POTTED_OAK_SAPLING)), false);
