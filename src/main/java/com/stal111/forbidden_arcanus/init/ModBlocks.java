...
public enum ModBlocks {
    ...
    RUNIC_TENEBRIS_CORE(new RunicTenebrisCoreBlock(addProperties(Material.ROCK, 2.0F, 15.0F).notSolid().func_235838_a_(state -> 12)), ModRenderType.CUTOUT),
    ...
    PIXIE_IN_A_BOTTLE_BLOCK(new BottleBlock(from(Blocks.GLASS)), ModRenderType.CUTOUT),
    CORRUPTED_PIXIE_IN_A_BOTTLE_BLOCK(new BottleBlock(from(Blocks.GLASS)), ModRenderType.CUTOUT),
    ...
    ARCANE_DRAGON_EGG(new ArcaneDragonEggBlock(from(Blocks.DRAGON_EGG).func_235838_a_(state -> 9))),
    ...
    IRON_CHAIN(new ChainBlock(addProperties(Material.IRON, 5.0F, 6.0F).func_235861_h_().sound(SoundType.field_235597_S_)), ModRenderType.CUTOUT),
    ARCANE_GOLDEN_CHAIN(new ChainBlock(addProperties(Material.IRON, 3.0F, 6.0F).func_235861_h_().sound(SoundType.field_235597_S_)), ModRenderType.CUTOUT),
    CANDLE_LAMP(new CandleLampBlock(addProperties(Material.ROCK).func_235838_a_(state -> 15)), ModRenderType.CUTOUT),
