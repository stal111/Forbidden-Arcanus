...
public class NewModBlocks {
    ...
    public static final RegistryObject<Block> PETRIFIED_ROOT = HELPER.register("petrified_root", new Block(Block.Properties.copy(Blocks.STONE).noOcclusion()), ValhelsiaRenderType.CUTOUT);
