...
public class NewModBlocks {
    ...
    public static final RegistryObject<StairBlock> CHERRYWOOD_STAIRS = HELPER.register("cherrywood_stairs", new StairBlock(() -> NewModBlocks.CHERRYWOOD_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS)));
    public static final RegistryObject<StairBlock> MYSTERYWOOD_STAIRS = HELPER.register("mysterywood_stairs", new StairBlock(() -> NewModBlocks.MYSTERYWOOD_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS)));
    public static final RegistryObject<StairBlock> EDELWOOD_STAIRS = HELPER.register("edelwood_stairs", new StairBlock(() -> NewModBlocks.EDELWOOD_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS)));
    ...
    public static final RegistryObject<TrapDoorBlock> ARCANE_GOLD_TRAPDOOR = HELPER.register("arcane_gold_trapdoor", new TrapDoorBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.GOLD).requiresCorrectToolForDrops().strength(3.0F).sound(SoundType.METAL).noOcclusion().isValidSpawn(NewModBlocks::never)), ValhelsiaRenderType.CUTOUT);
    public static final RegistryObject<TrapDoorBlock> FUNGYSS_TRAPDOOR = HELPER.register("fungyss_trapdoor", new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOL).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(NewModBlocks::never)), ValhelsiaRenderType.CUTOUT);
    public static final RegistryObject<TrapDoorBlock> CHERRYWOOD_TRAPDOOR = HELPER.register("cherrywood_trapdoor", new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(NewModBlocks::never)), ValhelsiaRenderType.CUTOUT);
    public static final RegistryObject<TrapDoorBlock> MYSTERYWOOD_TRAPDOOR = HELPER.register("mysterywood_trapdoor", new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(NewModBlocks::never)), ValhelsiaRenderType.CUTOUT);
    public static final RegistryObject<TrapDoorBlock> EDELWOOD_TRAPDOOR = HELPER.register("edelwood_trapdoor", new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(NewModBlocks::never)), ValhelsiaRenderType.CUTOUT);
    ...
    public static final RegistryObject<FlowerPotBlock> POTTED_YELLOW_ORCHID = HELPER.registerNoItem("potted_yellow_orchid", new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, NewModBlocks.YELLOW_ORCHID, Block.Properties.copy(Blocks.POTTED_OAK_SAPLING)), ValhelsiaRenderType.CUTOUT);
