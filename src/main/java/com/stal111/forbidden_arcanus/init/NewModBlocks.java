...
public class NewModBlocks {
    ...
    public static final RegistryObject<Block> ARCANE_GILDED_DARKSTONE = register("arcane_gilded_darkstone", new Block(Block.Properties.from(Blocks.STONE).hardnessAndResistance(2.0F, 8.0F).sound(SoundType.GILDED_BLACKSTONE)));
