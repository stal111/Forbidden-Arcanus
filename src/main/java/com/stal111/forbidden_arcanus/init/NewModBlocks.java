...
public class NewModBlocks {
    ...
    public static final RegistryObject<Block> DARKSTONE = HELPER.register("darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> DARKSTONE_SLAB = HELPER.register("darkstone_slab", new SlabBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> DARKSTONE_STAIRS = HELPER.register("darkstone_stairs", new StairBlock(() -> DARKSTONE.get().defaultBlockState(), Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> DARKSTONE_WALL = HELPER.register("darkstone_wall", new WallBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_GILDED_DARKSTONE = HELPER.register("arcane_gilded_darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F).sound(SoundType.GILDED_BLACKSTONE)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE = HELPER.register("polished_darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_SLAB = HELPER.register("polished_darkstone_slab", new SlabBlock(Block.Properties.copy(Blocks.STONE_SLAB).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_STAIRS = HELPER.register("polished_darkstone_stairs", new StairBlock(() -> POLISHED_DARKSTONE.get().defaultBlockState(), Block.Properties.copy(Blocks.STONE_STAIRS).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_WALL = HELPER.register("polished_darkstone_wall", new WallBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    ...
    public static final RegistryObject<Block> CHISELED_POLISHED_DARKSTONE = HELPER.register("chiseled_polished_darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> RUNIC_CHISELED_POLISHED_DARKSTONE = HELPER.register("runic_chiseled_polished_darkstone", new RunicChiseledPolishedDarkstone(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)), ValhelsiaRenderType.CUTOUT);
    public static final RegistryObject<Block> ARCANE_CHISELED_POLISHED_DARKSTONE = HELPER.register("arcane_chiseled_polished_darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_BRICKS = HELPER.register("polished_darkstone_bricks", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_BRICK_SLAB = HELPER.register("polished_darkstone_brick_slab", new SlabBlock(Block.Properties.copy(Blocks.STONE_SLAB).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_BRICK_STAIRS = HELPER.register("polished_darkstone_brick_stairs", new StairBlock(() -> POLISHED_DARKSTONE_BRICKS.get().defaultBlockState(), Block.Properties.copy(Blocks.STONE_STAIRS).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> POLISHED_DARKSTONE_BRICK_WALL = HELPER.register("polished_darkstone_brick_wall", new WallBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> CRACKED_POLISHED_DARKSTONE_BRICKS = HELPER.register("cracked_polished_darkstone_bricks", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_POLISHED_DARKSTONE = HELPER.register("arcane_polished_darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_POLISHED_DARKSTONE_SLAB = HELPER.register("arcane_polished_darkstone_slab", new SlabBlock(Block.Properties.copy(Blocks.STONE_SLAB).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_POLISHED_DARKSTONE_STAIRS = HELPER.register("arcane_polished_darkstone_stairs", new StairBlock(() -> ARCANE_POLISHED_DARKSTONE.get().defaultBlockState(), Block.Properties.copy(Blocks.STONE_STAIRS).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_POLISHED_DARKSTONE_WALL = HELPER.register("arcane_polished_darkstone_wall", new WallBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> CHISELED_ARCANE_POLISHED_DARKSTONE = HELPER.register("chiseled_arcane_polished_darkstone", new Block(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_POLISHED_DARKSTONE_PILLAR = HELPER.register("arcane_polished_darkstone_pillar", new PillarBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> ARCANE_POLISHED_DARKSTONE_ROD = HELPER.register("arcane_polished_darkstone_rod", new ArcanePolishedDarkstoneRod(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F)));
    public static final RegistryObject<Block> DARKSTONE_PEDESTAL = HELPER.register("darkstone_pedestal", new PedestalBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F).noOcclusion()));
    public static final RegistryObject<Block> ARCANE_DARKSTONE_PEDESTAL = HELPER.register("arcane_darkstone_pedestal", new PedestalBlock(Block.Properties.copy(Blocks.STONE).strength(2.0F, 8.0F).noOcclusion()));
    ...
    public static final RegistryObject<Block> ARCANE_CRYSTAL_ORE = HELPER.register("arcane_crystal_ore", new ModOreBlock(Block.Properties.of(Material.STONE).strength(3.0F)), ValhelsiaRenderType.CUTOUT);
