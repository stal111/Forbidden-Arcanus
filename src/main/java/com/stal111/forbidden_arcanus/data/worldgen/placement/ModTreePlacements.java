...
public class ModTreePlacements implements RegistryClass {
    ...
    public static final RegistryObject<PlacedFeature> SMALL_CHERRY_CHECKED = register("small_cherry_checked", ModConfiguredFeatures.SMALL_CHERRY.getHolder().get(), () -> List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.CHERRY_SAPLING.get())));
    public static final RegistryObject<PlacedFeature> LARGE_CHERRY_CHECKED = register("large_cherry_checked", ModConfiguredFeatures.LARGE_CHERRY.getHolder().get(), () -> List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.CHERRY_SAPLING.get())));
    public static final RegistryObject<PlacedFeature> AURUM_TREES = register("aurum_trees", ModConfiguredFeatures.AURUM.getHolder().get(), () -> List.of(InSquarePlacement.spread(), TREE_THRESHOLD, PlacementUtils.HEIGHTMAP_WORLD_SURFACE, PlacementUtils.countExtra(1, 0.2F, 1), BiomeFilter.biome()));
