...
public class ModBlockTagsProvider extends ValhelsiaBlockTagsProvider {
    ...
    protected void addTags(@NotNull HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(ModBlocks.OBSIDIANSTEEL_BLOCK.get(), ModBlocks.STELLA_ARCANUM.get(), ModBlocks.STELLARITE_BLOCK.get(), ModBlocks.HEPHAESTUS_FORGE_TIER_1.get()).addTag(ModTags.Blocks.RUNIC_STONES).addTag(ModTags.Blocks.RUNE_BLOCKS);
