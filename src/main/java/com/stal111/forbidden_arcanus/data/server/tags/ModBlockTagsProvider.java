...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(NewModBlocks.DARK_NETHER_STAR_BLOCK.get(), NewModBlocks.PROCESSED_OBSIDIAN_BLOCK.get(), NewModBlocks.STELLA_ARCANUM.get(), NewModBlocks.STELLARITE_BLOCK.get()).addTag(ModTags.Blocks.RUNIC_STONES).addTag(ModTags.Blocks.RUNE_BLOCKS);
