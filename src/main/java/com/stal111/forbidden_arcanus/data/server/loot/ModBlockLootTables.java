...
public class ModBlockLootTables extends ValhelsiaBlockLootTables {
    ...
    public void addTables() {
        ...
        take(block -> registerLootTable(block, droppingWithSilkTouch(block, withExplosionDecay(block, LootItem.lootTableItem(ModItems.ARCANE_CRYSTAL.get()).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE))))), NewModBlocks.ARCANE_CRYSTAL_ORE);
