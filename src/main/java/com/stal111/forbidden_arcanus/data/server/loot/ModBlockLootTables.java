...
public class ModBlockLootTables extends ValhelsiaBlockLootTables {
    ...
    public void addTables() {
        ...
        take(block -> add(block, droppingWithSilkTouch(block, ModItems.ARCANE_CRYSTAL.get()).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE))), NewModBlocks.ARCANE_CRYSTAL_ORE, NewModBlocks.DEEPSLATE_ARCANE_CRYSTAL_ORE);
        take(block -> add(block, droppingWithSilkTouch(block, ModItems.RUNE.get())), NewModBlocks.RUNIC_STONE, NewModBlocks.RUNIC_DEEPSLATE, NewModBlocks.RUNIC_DARKSTONE);
