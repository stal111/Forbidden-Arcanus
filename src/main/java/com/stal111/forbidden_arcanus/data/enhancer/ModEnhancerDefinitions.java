...
public class ModEnhancerDefinitions extends DatapackRegistryClass<EnhancerDefinition> {
    ...
    public void bootstrap(BootstapContext<EnhancerDefinition> context) {
        ...
        context.register(SOUL_CRIMSON_STONE, new EnhancerDefinition(ModItems.SOUL_CRIMSON_STONE.get(), this.generateDescription("soul_crimson_stone", EnhancerTarget.HEPHAESTUS_FORGE, EnhancerTarget.CLIBANO), List.of(new MultiplyRequiredEssenceEffect(List.of(), EssenceType.AUREAL, 0.5), new MultiplyRequiredEssenceEffect(List.of(), EssenceType.SOULS, 0.5), new MultiplyRequiredEssenceEffect(List.of(), EssenceType.BLOOD, 0.5))));
        ...
        context.register(MALEDICTUS_PACT, new EnhancerDefinition(ModItems.MALEDICTUS_PACT.get(), this.generateDescription("maledictus_pact", EnhancerTarget.HEPHAESTUS_FORGE), List.of(new MultiplyRequiredEssenceEffect(List.of(), EssenceType.AUREAL, 0.0), new MultiplyRequiredEssenceEffect(List.of(), EssenceType.SOULS, 0.0), new MultiplyRequiredEssenceEffect(List.of(), EssenceType.BLOOD, 0.0), new MultiplyRequiredEssenceEffect(List.of(), EssenceType.EXPERIENCE, 0.0))));
    }
