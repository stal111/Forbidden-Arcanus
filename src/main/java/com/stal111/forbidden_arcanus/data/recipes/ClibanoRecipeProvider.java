...
public class ClibanoRecipeProvider extends RecipeSubProvider {
    ...
    protected void registerRecipes() {
        this.add(this.clibanoRecipe(ModItems.ARCANE_CRYSTAL.get(), Ingredient.of(ModTags.Items.ARCANE_CRYSTAL_ORES), 1.0F, 100, new ClibanoRecipe.ResidueInfo("arcane_crystal", CHANCE_33)).unlockedBy("has_item", has(ModTags.Items.ARCANE_CRYSTAL_ORES)));
    ...
    private RecipeBuilder clibanoRecipe(ItemLike result, Ingredient ingredient, float experience, int cookingTime, ClibanoRecipe.ResidueInfo residueInfo) {
        return this.clibanoRecipe(result, ingredient, experience, cookingTime, residueInfo, ClibanoFireType.FIRE);
    }

    private RecipeBuilder clibanoRecipe(ItemLike result, Ingredient ingredient, float experience, int cookingTime, ClibanoRecipe.ResidueInfo residueInfo, ClibanoFireType fireType) {
        return SimpleCookingRecipeBuilder.generic(ingredient, RecipeCategory.MISC, result, experience, cookingTime, ModRecipeSerializers.CLIBANO_SERIALIZER.get(), (group, category, i, r, xp, time) -> new ClibanoRecipe(group, category, i, r, xp, time, residueInfo, fireType));
    }
}
