...
public class ClibanoRecipeProvider extends RecipeSubProvider {
    ...
    protected void registerRecipes(HolderLookup.Provider lookupProvider) {
        ...
        this.add(this.clibanoRecipe(ModItems.ARCANE_CRYSTAL.get(), Ingredient.of(ModTags.Items.ARCANE_CRYSTAL_ORES), 1.0F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.ARCANE_CRYSTAL), CHANCE_33)).unlockedBy("has_item", has(ModTags.Items.ARCANE_CRYSTAL_ORES)));
        this.add(this.clibanoRecipe(ModItems.ARCANE_CRYSTAL_DUST.get(), Ingredient.of(ModItems.ARCANE_CRYSTAL.get()), 0.4F, 80, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.ARCANE_CRYSTAL), CHANCE_10)).unlockedBy("has_item", has(ModItems.ARCANE_CRYSTAL.get())));
        this.add(this.clibanoRecipe(ModItems.RUNE.get(), Ingredient.of(ModTags.Items.RUNIC_STONES), 0.5F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.RUNE), CHANCE_10)).unlockedBy("has_item", has(ModTags.Items.RUNIC_STONES)));

        this.add(this.clibanoRecipe(Items.COAL, Ingredient.of(ItemTags.COAL_ORES), 0.05F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.COAL), CHANCE_33)).unlockedBy("has_item", has(ItemTags.COAL_ORES)));
        this.add(this.clibanoRecipe(Items.IRON_INGOT, Ingredient.of(ItemTags.IRON_ORES), 0.35F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.IRON), CHANCE_33)).unlockedBy("has_item", has(ItemTags.IRON_ORES)));
        this.add(this.clibanoRecipe(Items.GOLD_INGOT, Ingredient.of(ItemTags.GOLD_ORES), 0.5F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.GOLD), CHANCE_20)).unlockedBy("has_item", has(ItemTags.GOLD_ORES)));
        this.add(this.clibanoRecipe(Items.COPPER_INGOT, Ingredient.of(ItemTags.COPPER_ORES), 0.35F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.COPPER), CHANCE_33)).unlockedBy("has_item", has(ItemTags.COPPER_ORES)));
        this.add(this.clibanoRecipe(Items.LAPIS_LAZULI, Ingredient.of(ItemTags.LAPIS_ORES), 0.1F, 100, new ResidueChance(residueLookup.getOrThrow(ModResidueTypes.LAPIS_LAZULI), CHANCE_20)).unlockedBy("has_item", has(ItemTags.LAPIS_ORES)));
    ...
    private RecipeBuilder clibanoRecipe(ItemLike result, Ingredient firstIngredient, Ingredient secondIngredient, float experience, int cookingTime, ResidueChance chance) {
        return this.clibanoRecipe(result, firstIngredient, secondIngredient, experience, cookingTime, chance, null);
    }

    private RecipeBuilder clibanoRecipe(ItemLike result, Ingredient firstIngredient, Ingredient secondIngredient, float experience, int cookingTime, ResidueChance chance, @Nullable Holder<EnhancerDefinition> enhancer) {
        return SimpleCookingRecipeBuilder.generic(null, RecipeCategory.MISC, result.asItem().getDefaultInstance(), experience, cookingTime, ModRecipeSerializers.CLIBANO_SERIALIZER.get(), (group, category, i, r, xp, time) -> new ClibanoRecipe(group, category, NonNullList.of(Ingredient.EMPTY, firstIngredient, secondIngredient), r, xp, time, chance, ClibanoFireType.FIRE, enhancer));
    }
    ...
    private RecipeBuilder clibanoRecipe(ItemLike result, Ingredient ingredient, float experience, int cookingTime, ResidueChance chance, ClibanoFireType fireType) {
        return SimpleCookingRecipeBuilder.generic(ingredient, RecipeCategory.MISC, result.asItem().getDefaultInstance(), experience, cookingTime, ModRecipeSerializers.CLIBANO_SERIALIZER.get(), (group, category, i, r, xp, time) -> new ClibanoRecipe(group, category, NonNullList.of(Ingredient.EMPTY, i), r, xp, time, chance, fireType, null));
    }
}
