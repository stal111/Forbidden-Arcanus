...
public class ModItemModelProvider extends ValhelsiaItemModelProvider {
    ...
    private static final List<Item> ENHANCER_ITEM = ImmutableList.of(ModItems.ARTISAN_RELIC.get(), ModItems.CRESCENT_MOON.get(), ModItems.CRIMSON_STONE.get(), ModItems.SOUL_CRIMSON_STONE.get(), ModItems.ELEMENTARIUM.get(), ModItems.DIVINE_PACT.get(), ModItems.MALEDICTUS_PACT.get());
