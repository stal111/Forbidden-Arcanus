...
public class BiomeFeatures {
    ...
    public static final BlockClusterFeatureConfig EDELWOOD = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(ModBlocks.EDELWOOD_LOG.getState().with(EdelwoodLogBlock.LEAVES, true)), new ColumnBlockPlacer(2, 2))).func_227316_a_(ImmutableSet.of(Blocks.GRASS_BLOCK)).tries(10).func_227317_b_().build();
    public static final BlockClusterFeatureConfig YELLOW_ORCHID = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(ModBlocks.YELLOW_ORCHID.getState()), new SimpleBlockPlacer())).func_227316_a_(ImmutableSet.of(Blocks.GRASS_BLOCK)).tries(10).build();
}
