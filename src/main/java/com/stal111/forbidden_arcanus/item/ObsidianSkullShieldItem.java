...
public class ObsidianSkullShieldItem extends Item {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entity, int itemSlot, boolean isSelected) {
		if (entity instanceof  LivingEntity) {
			...
			if (!worldIn.isRemote) {
				...
				livingEntity.addPotionEffect(new EffectInstance(Effects.RESISTANCE, 200, 0, false, false, true));
			}
		}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add((new TranslationTextComponent("tooltip." + Main.MOD_ID + ".obsidian_skull_shield")).applyTextStyle(TextFormatting.GRAY));
	}
