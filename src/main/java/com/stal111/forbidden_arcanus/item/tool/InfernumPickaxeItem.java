...
public class InfernumPickaxeItem extends ToolPickaxe {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add((new TextComponentTranslation("tooltip." + Main.MODID + ".infernum_pickaxe")).applyTextStyle(TextFormatting.GRAY));
	}
