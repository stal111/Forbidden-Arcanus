...
//                    tooltip.clear();
//                    tooltip.add(Component.translatable("jei.forbidden_arcanus.hephaestusSmithing.requiredPedestal").append(": ").append(recipe.getPedestalType().getBlock().getName()));
//                    tooltip.add(Component.translatable("jei.forbidden_arcanus.hephaestusSmithing.requiredLevel").append(": 1"));
//                });
//    }
//
//    @Override
...
//                return Collections.singletonList(Component.translatable("jei.forbidden_arcanus.hephaestusSmithing.required" + essenceInfo.name()).append(": " + recipe.getEssences().getFromName(essenceInfo.name())));
//            }
//        }
//
