...
public class HephaestusSmithingCategory implements IRecipeCategory<Ritual> {
    ...
    private static final Pair<Integer, Integer> FORGE_ITEM_POSITION = new Pair<>(62, 34);
    private static final Pair<Integer, Integer> OUTPUT_POSITION = new Pair<>(120, 35);
    private static final Pair<Integer, Integer> PEDESTAL_TYPE_POSITION = new Pair<>(122, 84);
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull Ritual recipe, @Nonnull IIngredients ingredients) {
        ...
        itemStacks.init(0, true, FORGE_ITEM_POSITION.getFirst(), FORGE_ITEM_POSITION.getSecond());
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (ingredient != null) {
                itemStacks.init(index, true, INPUT_POSITIONS.get(i).getFirst(), INPUT_POSITIONS.get(i).getSecond());
        ...
        itemStacks.init(index, false, OUTPUT_POSITION.getFirst(), OUTPUT_POSITION.getSecond());
        itemStacks.set(index, recipe.getResult());

        index++;
        itemStacks.init(index, false, PEDESTAL_TYPE_POSITION.getFirst(), PEDESTAL_TYPE_POSITION.getSecond());
