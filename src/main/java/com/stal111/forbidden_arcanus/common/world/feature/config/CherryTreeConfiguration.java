...
public class CherryTreeConfiguration extends TreeConfiguration {
    ...
    public static final Codec<CherryTreeConfiguration> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), RootPlacer.CODEC.optionalFieldOf("root_placer").forGetter((configuration) -> {
            return configuration.rootPlacer;
    ...
    public CherryTreeConfiguration(BlockStateProvider trunkProvider, BlockStateProvider thinTrunkProvider, TrunkPlacer trunkPlacer, BlockStateProvider foliageProvider, FoliagePlacer foliagePlacer, Optional<RootPlacer> rootPlacer, BlockStateProvider dirtProvider, FeatureSize featureSize, List<TreeDecorator> decorators, boolean ignoreVines, boolean forceDirt) {
        super(trunkProvider, trunkPlacer, foliageProvider, foliagePlacer, rootPlacer, dirtProvider, featureSize, decorators, ignoreVines, forceDirt);
