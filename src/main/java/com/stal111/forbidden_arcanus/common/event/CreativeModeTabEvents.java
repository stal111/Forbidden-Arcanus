    ...
    public void registerTabs(CreativeModeTabEvent.Register event) {
        ...
        event.registerCreativeModeTab(new ResourceLocation(ForbiddenArcanus.MOD_ID, "main"), builder -> builder
                ...
                .displayItems((displayParameters, output) -> {
                    ...
                    output.accept(ModBlocks.CHERRY_LEAF_CARPET.get());
                    output.accept(ModBlocks.CHERRY_FLOWER_VINES.get());
                    ...
                    output.accept(ModBlocks.CHERRY_LOG.get());
                    output.accept(ModBlocks.THIN_CHERRY_LOG.get());
                    ...
                    output.accept(ModBlocks.STRIPPED_CHERRY_LOG.get());
                    output.accept(ModBlocks.STRIPPED_AURUM_LOG.get());
                    output.accept(ModBlocks.FUNGYSS_HYPHAE.get());
                    output.accept(ModBlocks.CHERRY_WOOD.get());
                    output.accept(ModBlocks.AURUM_WOOD.get());
                    output.accept(ModBlocks.STRIPPED_CHERRY_WOOD.get());
                    output.accept(ModBlocks.STRIPPED_AURUM_WOOD.get());
                    output.accept(ModBlocks.FUNGYSS_PLANKS.get());
                    output.accept(ModBlocks.CHERRY_PLANKS.get());
                    output.accept(ModBlocks.CARVED_CHERRY_PLANKS.get());
                    ...
                    output.accept(ModBlocks.CHERRY_SLAB.get());
                    ...
                    output.accept(ModBlocks.CHERRY_STAIRS.get());
                    ...
                    output.accept(ModBlocks.CHERRY_DOOR.get());
                    ...
                    output.accept(ModBlocks.CHERRY_TRAPDOOR.get());
                    ...
                    output.accept(ModBlocks.CHERRY_FENCE.get());
                    ...
                    output.accept(ModBlocks.CHERRY_FENCE_GATE.get());
                    output.accept(ModBlocks.AURUM_FENCE_GATE.get());
                    output.accept(ModBlocks.EDELWOOD_FENCE_GATE.get());
                    output.accept(ModBlocks.FUNGYSS_SIGN.getFirst().get());
                    output.accept(ModBlocks.CHERRY_SIGN.getFirst().get());
                    output.accept(ModBlocks.AURUM_SIGN.getFirst().get());
                    output.accept(ModBlocks.EDELWOOD_SIGN.getFirst().get());
                    output.accept(ModBlocks.EDELWOOD_LADDER.get());
                    output.accept(ModBlocks.FUNGYSS_BUTTON.get());
                    output.accept(ModBlocks.CHERRY_BUTTON.get());
                    ...
                    output.accept(ModBlocks.CHERRY_PRESSURE_PLATE.get());
                    ...
                    output.accept(ModItems.CHERRY_PEACH.get());
                    ...
                    output.accept(ModItems.ETERNAL_OBSIDIAN_SKULL.get());
                    ...
                    output.accept(ModItems.CHERRY_BOAT.get());
                    output.accept(ModItems.CHERRY_CHEST_BOAT.get());
