...
public class ArcaneBaseBlockRodBlock extends RotatedPillarBlock implements IWaterLoggable {
	...
	private static final VoxelShape[] SHAPE_X = { Block.makeCuboidShape(0, 6, 6, 2, 10, 10),
			Block.makeCuboidShape(0, 6.5, 6.5, 16, 9.5, 9.5), Block.makeCuboidShape(14, 6, 6, 16, 10, 10) },
			SHAPE_Y = { Block.makeCuboidShape(6, 0, 6, 10, 2, 10), Block.makeCuboidShape(6.5, 0, 6.5, 9.5, 16, 9.5),
					Block.makeCuboidShape(6, 14, 6, 10, 16, 10) },
			SHAPE_Z = { Block.makeCuboidShape(6, 6, 0, 10, 10, 2), Block.makeCuboidShape(6.5, 6.5, 0, 9.5, 9.5, 16),
