...
public class CandleBlock extends WaterloggedBlock {

	protected static final VoxelShape SHAPE = Block.makeCuboidShape(6.0D, 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);

	public CandleBlock(String name, Properties properties) {
		super(name, properties.doesNotBlockMovement().lightValue(15));
	}
