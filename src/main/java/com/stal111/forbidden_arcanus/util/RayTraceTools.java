...
public class RayTraceTools {
    ...
    public static void rayTrace(Beam beam, Function<Entity, Boolean> consumer) {
        ...
        List<Entity> targets = world.getEntitiesInAABBexcluding(player,
                ...
                EntityPredicates.NOT_SPECTATING.and(ent -> ent != null && ent.canBeCollidedWith()));
        ...
        for (Entity target : targets) {
            ...
            if (targetBB.contains(start)) {
                ...
                RayTraceResult targetResult = world.rayTraceBlocks(new RayTraceContext(start, end, RayTraceContext.BlockMode.COLLIDER, RayTraceContext.FluidMode.NONE, player));
    ...
    public static class Beam {
        ...
        private void calculate() {
            ...
            RayTraceResult result = this.world.rayTraceBlocks(new RayTraceContext(start, end, RayTraceContext.BlockMode.COLLIDER, RayTraceContext.FluidMode.NONE, player));
