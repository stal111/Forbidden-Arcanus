...
public class WorldGenConfig {
	...
	public static void init(ForgeConfigSpec.Builder SERVER_BUILDER, ForgeConfigSpec.Builder CLIENT_BUILDER) {
		...
		DARK_RUNESTONE_MAX_VEIN_SIZE = SERVER_BUILDER.comment("Maximum size of Dark Runestone vein").defineInRange("oregen.maxDarkRunestoneVeinSize", 4, 0, 500);
		DARK_RUNESTONE_COUNT = SERVER_BUILDER.comment("Maximum Dark Runestone veins per chunk").defineInRange("oregen.DarkRunestoneCount", 2, 1, 10000000);
